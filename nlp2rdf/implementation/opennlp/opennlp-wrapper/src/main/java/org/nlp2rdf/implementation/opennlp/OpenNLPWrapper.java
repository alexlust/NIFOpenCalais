...
public class OpenNLPWrapper {
    ...
    public void processText(String prefix, String text, URIGenerator urigenerator, OntModel model) {
        ...
        Document document = text2RDF.createDocumentAnnotation(prefix, text, urigenerator, model);
        text2RDF.generateNIFModel(prefix, text, tokenizedText, urigenerator, document, model);
