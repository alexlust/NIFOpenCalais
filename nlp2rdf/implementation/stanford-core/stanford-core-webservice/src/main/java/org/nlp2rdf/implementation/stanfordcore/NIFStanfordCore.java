 ...
 *         Created: 29.05.11
 */
public class NIFStanfordCore extends NIFServlet {
    private final StanfordCoreNLPWrapper stanfordCoreNLPWrapper;

    public NIFStanfordCore() {
        this.stanfordCoreNLPWrapper = new StanfordCoreNLPWrapper(new OLiAManager(new ClasspathLoader()));
    }
