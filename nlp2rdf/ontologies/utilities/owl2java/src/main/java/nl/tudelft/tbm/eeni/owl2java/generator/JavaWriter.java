...
public class JavaWriter {
    ...
    private void initVelocityEngine() {
        ...
        try {
            ...
            //System.out.println(JavaWriter.class.getResource(""));
            //System.exit(0);

            //vEngine.setProperty("resource.loader", "class");
            //vEngine.setProperty("class.resource.loader.description", " Velocity Classpath Resource Loader");
            ...
            vEngine.init();
            /*URL u = this.getClass().getClassLoader().getResource("nl/tudelft/tbm/eeni/owl2java/generator/templates/interface.vm");
             u = this.getClass().getClassLoader().getResource("interface.vm");
            System.out.println(JavaWriter.class.getResource(""));
            System.out.println(JavaWriter.class.getResource("")+"templates/");

            System.out.println(u);

            vEngine.getTemplate(TEMPLATE_ROOT+"inferface.vm");
              System.exit(0);
                                                              */
            /* System.out.println(JavaWriter.class.getResource("templates") + "/");
             System.out.println(this.getClass().getResource("templates") + "/");
             System.out.println(this.getClass().getClassLoader().getResource(""));
             System.out.println(this.getClass().getClassLoader().getResource("templates") + "/");

            vEngine.getTemplate("nl.tudelft.tbm.eeni.owl2java.generator.templates/inferface.vm");
            //vEngine.getTemplate("nl/tudelft/tbm/eeni/owl2java/generator/templates/inferface.vm");
            */
        } catch (Exception e) {
            log.error("", e);
