...
public class URIComparator implements Comparator<Individual> {
    ...
    public URIComparator(String prefix, String text, URIGenerator uriGenerator) {
        this.prefix = prefix;
        this.text = text;
    ...
    public int compare(Individual o1, Individual o2) {
        ...
        try {
            ...
            Span a = uriGenerator.getSpanFor(prefix, o1.getURI(), text);
            Span b = uriGenerator.getSpanFor(prefix, o2.getURI(), text);
